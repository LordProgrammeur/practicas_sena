...
<?php
require_once "controllers/Dashboard.php"; //aca se llama como una pegatina a landing y lo pega al frente
$controller = new Dashboard; // si no se crea el objeto no se puede usar la funcion
